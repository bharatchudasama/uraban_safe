...
public class Accident extends JFrame implements ActionListener {
    JButton submit , exit ;
    Accident(){

        JLabel heading1 = new JLabel("Accident");
        heading1.setBounds(80,10,200,40);
        heading1.setFont(new Font("Tahoma",Font.BOLD,35));
        heading1.setForeground(Color.BLACK);
        add(heading1);

        JLabel heading2 = new JLabel("Prevention");
        heading2.setBounds(60,60,200,40);
